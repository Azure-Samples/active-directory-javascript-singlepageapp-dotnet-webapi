...
#> 
   ...
   Write-Host "Creating the AAD appplication (SinglePageApp)"
   $spaAadApplication = New-AzureADApplication -DisplayName "SinglePageApp" `
                                               -HomePage "https://localhost:44302/" `
                                               -ReplyUrls "https://localhost:44302/" `
                                               -IdentifierUris "https://$tenantName/SinglePageApp" `
   ...
   Add-Content -Value "<tr><td>spa</td><td>$currentAppId</td><td><a href='$spaPortalUrl'>SinglePageApp</a></td></tr>" -Path createdApps.html
   ...
   $dictionary = @{ "tenant" = $tenantName;"clientId" = $spaAadApplication.AppId };
   ...
   ReplaceSetting -configFilePath $configFile -key "ida:Audience" -newValue $spaAadApplication.AppId
